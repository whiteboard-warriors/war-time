...
## For video instruction on how to use this VS CODE extention, watch [this video by Brad Traversy starting at 18:13m.](https://www.youtube.com/watch?v=LdF2RcelRg0)
...
You can also specify file path to use as a body, which starts with `<`, the file path(_whitepsaces_ should be preserved) can be either in absolute or relative(relative to workspace root or current http file) formats:
